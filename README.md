...
#### Q1: What are the drawbacks of those approaches? (hint: time and resource)
...
## 5.Critical Thinking
#### However, one potential weakness of the paper is that its focus on a specific type of text classification task, which is document classification. Although this is a common and important task, there are many other types of text classification tasks that may have different requirements or challenges. 
